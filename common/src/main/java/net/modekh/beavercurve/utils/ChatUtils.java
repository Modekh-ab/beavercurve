...
public class ChatUtils {
    ...
    public static MutableComponent polishSender() {
        return sender(Component.translatable("message." + Reference.MOD_ID + ".skunks").getString());
    }
    ...
    public static void sendPolishMessage(Player player, MutableComponent message, boolean bar) {
        sendMessage(player, polishSender(), message, bar);
    }
}
